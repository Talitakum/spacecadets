class CadetsController < ApplicationController
  ...
  private
    ...
    def cadet_params
      params.require(:cadet).permit(:email, :password, :name, :surname, :street, :city, :country, :institution, :tshirtsize, :formalshirtsize, :waistsize, :shoesize, :hipsize, :suitjacketsize, :dresssize, :gender, :age, :language, :eyecolour, :race, :height, :weight, :haircolour, :weekdays, :weekends, :afterhours, :publicholidays)
    end
end
